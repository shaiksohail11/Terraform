resource "azurerm_network_interface" "nic" {
  ...
  name                = "voziq_${var.resource_group_location}_${var.client_name}_${var.network_interface_names[count.index]}_${var.environment_name}"
...
resource "azurerm_network_security_group" "nsg" {
  ...
  name                = "voziq_${var.resource_group_location}_${var.client_name}_${var.nsg_names[count.index]}_${var.environment_name}"
  resource_group_name = var.resource_group_name
  location            = var.resource_group_location
...
resource "azurerm_linux_virtual_machine" "vm" {
  ...
  name                            = "voziq-${var.vm_names[count.index]}"
  resource_group_name             = var.resource_group_name
  location                        = var.resource_group_location
...
resource "azurerm_managed_disk" "managed_disk" {
  ...
  name                 = "voziq_${var.resource_group_location}_${var.client_name}_${var.disk_names[count.index]}_${var.environment_name}"
  resource_group_name  = var.resource_group_name
  location             = var.resource_group_location
  storage_account_type = "Standard_LRS"
  create_option        = "Empty"
